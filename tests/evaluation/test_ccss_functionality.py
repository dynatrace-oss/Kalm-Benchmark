...
from kalm_benchmark.evaluation.ccss.ccss_models import MisconfigurationFinding, ScannerCCSSAlignment, SourceType
...
class TestCCSSModels:
    ...
    def test_misconfiguration_finding_creation(self):
        ...
        assert finding.native_score == 7.0
        assert finding.ccss_score == 6.5
        assert finding.alignment_score == 0.85
    ...
    def test_scanner_ccss_alignment_creation(self):
        ...
        assert alignment.avg_alignment_score == 0.82
...
class TestCCSSDatabase:
    ...
    def test_create_evaluation_run(self, temp_db):
        run_id = temp_db.create_evaluation_run(
            ...
            total_charts_scanned=10,
            scanners_evaluated=["trivy", "checkov"]
        )
    ...
    def test_alignment_statistics(self, temp_db):
        ...
        assert stats['avg_alignment'] == 0.75
...
class TestCCSSConverter:
    ...
    def test_checkresult_to_misconfiguration_finding(self):
        ...
        assert finding.native_score == 7.0  # HIGH maps to 7.0
    ...
    def test_batch_convert_check_results(self):
        ...
        findings = CCSSConverter.batch_convert_check_results(
    ...
    def test_severity_to_score_mapping(self):
        ...
        assert CCSSConverter._severity_to_score("CRITICAL") == 9.0
        assert CCSSConverter._severity_to_score("HIGH") == 7.0
        assert CCSSConverter._severity_to_score("MEDIUM") == 4.0
        assert CCSSConverter._severity_to_score("LOW") == 2.0
        assert CCSSConverter._severity_to_score("INFO") == 1.0
...
class TestCCSSService:
    ...
    def test_create_evaluation_run(self, temp_service):
        run_id = temp_service.create_evaluation_run(
            ...
            total_charts_scanned=100,
            scanners_evaluated=["trivy", "checkov", "polaris"]
        )
