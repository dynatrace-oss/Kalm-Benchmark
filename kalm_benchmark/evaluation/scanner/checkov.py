...
CHECK_MAPPING = {
    "CKV_K8S_1": (CheckCategory.PSP, ".spec.hostPID"),
    "CKV_K8S_2": (CheckCategory.PSP, ".spec.privileged"),
    "CKV_K8S_3": (CheckCategory.PSP, [".spec.serviceAccount", ".spec.hostIPC"]),
    "CKV_K8S_4": (CheckCategory.PSP, ".spec.hostNetwork"),
    "CKV_K8S_5": (CheckCategory.PSP, ".spec.allowPrivilegeEscalation"),
    "CKV_K8S_6": (CheckCategory.PSP, ".spec.runAsUser.rule"),
    "CKV_K8S_7": (CheckCategory.PSP, ".spec.allowedCapabilities"),
    ...
    "CKV_K8S_14": (CheckCategory.SupplyChain, ".spec.containers[].image"),
    "CKV_K8S_15": (CheckCategory.SupplyChain, ".spec.containers[].imagePullPolicy"),
    "CKV_K8S_16": (CheckCategory.PodSecurity, ".spec.containers[].securityContext.privileged"),
    "CKV_K8S_17": (CheckCategory.PodSecurity, ".spec.hostPID"),
    "CKV_K8S_18": (CheckCategory.PodSecurity, ".spec.hostIPC"),
    "CKV_K8S_19": (CheckCategory.PodSecurity, ".spec.hostNetwork"),
    "CKV_K8S_20": (CheckCategory.PodSecurity, ".spec.containers[].securityContext.allowPrivilegeEscalation"),
    "CKV_K8S_21": (CheckCategory.Workload, ".metadata.namespace"),
    "CKV_K8S_22": (CheckCategory.PodSecurity, ".spec.containers[].securityContext.readOnlyRootFilesystem"),
    "CKV_K8S_23": (
        CheckCategory.PodSecurity,
        [".spec.containers[].securityContext.runAsNonRoot", ".spec.containers[].securityContext.runAsUser"],
    ),
    "CKV_K8S_24": (CheckCategory.PSP, ".spec.allowedCapabilities"),
    "CKV_K8S_25": (CheckCategory.PodSecurity, ".spec.containers[].securityContext.capabilities"),
    "CKV_K8S_26": (CheckCategory.PodSecurity, ".spec.containers[].ports[].hostPort"),
    "CKV_K8S_27": (CheckCategory.PodSecurity, ".spec.volumes[].hostPath.path"),
    "CKV_K8S_28": (CheckCategory.PodSecurity, ".spec.containers[].securityContext.capabilities.drop"),
    "CKV_K8S_29": (CheckCategory.PodSecurity, [".spec.containers[].securityContext", ".spec.securityContext"]),
    "CKV_K8S_30": (CheckCategory.PodSecurity, [".spec.containers[].securityContext", ".spec.securityContext"]),
    "CKV_K8S_31": (CheckCategory.PodSecurity, ".spec.securityContext.seccompProfile.type"),
    "CKV_K8S_32": (
        CheckCategory.PSP,
    ...
    "CKV_K8S_36": (CheckCategory.PSP, [".spec.allowedCapabilities", "requiredDropCapabilities"]),
    "CKV_K8S_37": (CheckCategory.PodSecurity, ".spec.containers[].securityContext.capabilities.drop"),
    "CKV_K8S_38": (CheckCategory.PodSecurity, ".spec.automountServiceAccountToken"),
    "CKV_K8S_39": (CheckCategory.PodSecurity, ".spec.containers[].securityContext.capabilities.add"),
    "CKV_K8S_40": (
        CheckCategory.PodSecurity,
        [".spec.securityContext.runAsUser", ".spec.containers[].securityContext.runAsUser"],
    ),
    "CKV_K8S_41": (CheckCategory.RBAC, ["ServiceAccount.automountServiceAccountToken", "ServiceAccount.name"]),
    "CKV_K8S_42": (CheckCategory.RBAC, ["RoleBinding.subjects[].name", "ClusterRoleBinding.subjects[].name"]),
    "CKV_K8S_43": (CheckCategory.SupplyChain, ".spec.containers[].image"),
    ...
    "CKV_K8S_78": (CheckCategory.PodSecurity, "AdmissionConfiguration.plugins[].name"),  # has to be "EventRateLimit"
