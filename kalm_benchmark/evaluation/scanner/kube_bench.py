...
CHECK_MAPPING = {
    "5.1.1": ("RBAC-001", CheckCategory.IAM),
    ...
    "5.2.2": ("PSS-002", CheckCategory.AdmissionControl),
    "5.2.3": ("PSS-004", CheckCategory.AdmissionControl),
    "5.2.4": ("PSS-005", CheckCategory.AdmissionControl),
    "5.2.5": ("PSS-006", CheckCategory.AdmissionControl),
    "5.2.6": ("PSS-003", CheckCategory.AdmissionControl),
    "5.2.7": ("PSS-008", CheckCategory.AdmissionControl),
    "5.2.8": ("PSS-010", CheckCategory.AdmissionControl),
    "5.2.9": ("PSS-011", CheckCategory.AdmissionControl),
    "5.2.10": ("PSS-012", CheckCategory.AdmissionControl),
    "5.2.11": ("PSS-013", CheckCategory.AdmissionControl),
    "5.2.12": ("PSS-014", CheckCategory.AdmissionControl),
    "5.2.13": ("PSS-015", CheckCategory.AdmissionControl),
    "5.3.1": ("NP-000", CheckCategory.Network),
    "5.3.2": ("NP-001", CheckCategory.Network),
    "5.4.1": ("POD-024", CheckCategory.DataSecurity),
