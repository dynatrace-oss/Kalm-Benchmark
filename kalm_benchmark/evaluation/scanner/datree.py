...
CHECK_MAPPING = {
    ...
    "DEPLOYMENT_INCORRECT_REPLICAS_VALUE": (CheckCategory.Reliability, "Deployment.spec.replicas"),
    "ENDPOINTSLICE_CVE2021_25373_INCORRECT_ADDRESSES_VALUE": (
        CheckCategory.Vulnerability,
        "EndpointSlice.endpoints[].addresses",
    ),
    "HPA_MISSING_MINREPLICAS_KEY": (CheckCategory.Reliability, "HorizontalPodAutoscaler.minReplicas"),
    "HPA_MISSING_MAXREPLICAS_KEY": (CheckCategory.Reliability, "HorizontalPodAutoscaler.maxReplicas"),
    ...
    "WORKLOAD_INCORRECT_NAMESPACE_VALUE_DEFAULT": (CheckCategory.Segregation, ".metadata.namespace"),
