...
class UILogger:
    ...
    def __init__(self, data_dir: Optional[Path] = None):
        ...
        # Store logs in root logs directory instead of data/logs
        self.log_dir = Path("./logs")
        self.log_dir.mkdir(parents=True, exist_ok=True)
        
        # Create log files for different types of operations
    ...
    def _setup_loggers(self):
        ...
        # Console logger for development (only errors)
        logger.add(
            sys.stderr,
            level="ERROR",
        ...
        # File logger for scan operations
        logger.add(
    ...
    def log_scan_complete(self, tool_name: str, success: bool, result_file: Optional[Path] = None):
        ...
        if success and result_file:
            logger.bind(component="scan").success(f"Scan completed successfully for {tool_name}. Results saved to {result_file}")
        elif success:
    ...
    def get_log_files(self) -> dict[str, Path]:
        ...
        return {
            "scan_logs": self.scan_log_file,
            "ui_logs": self.ui_log_file
        }
